    ...
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.section}>
        ...
        <Text style={styles.text}>
          Conectar pessoas a oportunidades de voluntariado e doações em suas
          cidades, facilitando o engajamento em causas sociais e promovendo um
      ...
      <View style={styles.section}>
        ...
        <View style={styles.stepContainer}>
          ...
          <View style={styles.stepContent}>
            ...
            <Text style={styles.stepText}>
              Navegue pelas diversas oportunidades de voluntariado e doações
        ...
        <View style={styles.stepContainer}>
          ...
          <View style={styles.stepContent}>
            ...
            <Text style={styles.stepText}>
              Preencha um formulário simples para se candidatar como voluntário
              ou fazer uma doação.
            </Text>
          </View>
        </View>
