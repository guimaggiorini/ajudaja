...
function OpportunityDetailsScreen({
  route,
  navigation,
}: OpportunityDetailsScreenProps) {
  ...
  const handleContactPress = (type: "phone" | "email", value: string) => {
    ...
    Linking.openURL(url).catch(() => {
      Alert.alert(
        "Erro",
        `Não foi possível ${type === "phone" ? "ligar" : "enviar email"}.`,
      );
    });
  };
      ...
      <View style={styles.content}>
        ...
        <View>
          ...
          <TouchableOpacity
            ...
            onPress={() =>
              handleContactPress("phone", opportunity.contactPhone)
            }
          >
          ...
          <TouchableOpacity
            style={styles.contactItem}
            onPress={() =>
              handleContactPress("email", opportunity.contactEmail)
            }
          >
