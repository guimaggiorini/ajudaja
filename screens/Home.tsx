  ...
  return (
    <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
      <View style={styles.bannerContainer}>
        <Image
          source={{
            uri: "https://images.unsplash.com/photo-1488521787991-ed7bbaae773c?q=80&w=2940&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
          }}
      ...
      <View style={styles.welcomeSection}>
        ...
        <Text style={styles.welcomeText}>
          Descubra ONGs perto de você e faça a diferença como voluntário. Sua
          ajuda transforma vidas!
        </Text>
      </View>
